...
const features = [
  ...
  },
  {
    ...
    desc: "Accept, fund, confirm completion, or open dispute on a delivery.",
  ...
  },
  {
    icon: Scale,
    title: "Adjudicate",
    desc: "Open dispute, run AI jury, settle payment, recover after deadline.",
    href: "/dashboard/adjudicate",
    color: "#dc2626",
  },
];
